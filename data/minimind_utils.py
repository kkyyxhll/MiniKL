...
def read_data_jsonl(jsonl_path):
    ...
    with open(jsonl_path, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            text = str(data['text']).replace("<|im_start|>", "<s>").replace("<|im_end|>", "</s>")

            id_content_dict[count] = text
            count += 1
...
if __name__ == '__main__':
    in_data_jsonl_path = "/home/kkyyxhll/Projects/PythonProjects/MiniKL/data/pretrain_hq.jsonl"
    out_dir_path = "minimind_out"
    n = 1
